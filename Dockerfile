...
RUN apk update \
    ...
    && cd /tmp \
    # && git clone https://github.com/openresty/headers-moheaders-morere-nginx-module \
    && git clone https://github.com/stnoonan/spnego-http-auth-nginx-module.git \
    #&& git clone --depth 1 --branch v1.1.1 https://github.com/stnoonan/spnego-http-auth-nginx-module.git \
    && cd /etc \
